...
KILOMETER_PER_HOUR = (    _l.KILOMETER[0] / _HOUR_VALUE, ['km/h'] + _getNames('per hour', _l.KILOMETER[1]))
MILE_PER_HOUR =      (         _l.MILE[0] / _HOUR_VALUE, ['mph'] + _getNames('per hour', _l.MILE[1]))
