from chalicelib.units import area as _a
...
POUND_PER_SQUARE_INCH = (4.4482 / _a.INCH_SQUARE[0], [
    'psi', 'pound-force per square inch', 'pound-forces per square inch',
    'pound per square inch', 'pounds per square inch', 'lbf/in2', 'lnf/sq in'
], 'BAR')
