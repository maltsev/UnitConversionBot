...
MILLIMETER_CUBIC = (
    _l.MILLIMETER[0] ** 3,
    _getNames(_l.MILLIMETER[1]),
    "CENTIMETER_CUBIC",
)
CENTIMETER_CUBIC = (
    _l.CENTIMETER[0] ** 3,
    _getNames(_l.CENTIMETER[1]) + ["cc"],
    "MILLILITER",
)
...
LITER = (
    DECIMETER_CUBIC[0],
    ["l", "liter", "liters", "litre", "litres", "lt", "ltr"],
    "MILLILITER",
)
MILLILITER = (
    CENTIMETER_CUBIC[0],
...
IMPERIAL_PINT = (
    IMPERIAL_FLUID_OUNCE[0] * 20,
    ["pt", "imperial pint", "imperial pints", "pint", "pints"],
    "MILLILITER",
)
IMPERIAL_QUART = (
    IMPERIAL_FLUID_OUNCE[0] * 40,
    ["qt", "imperial quart", "imperial quarts", "quart", "quarts"],
    "LITER",
)
IMPERIAL_GALLON = (
    IMPERIAL_FLUID_OUNCE[0] * 160,
    ["gal", "imperial gallon", "imperial gallons", "gallon", "gallons"],
    "LITER",
)

US_FLUID_OUNCE = (
    29.5735295625 * MILLILITER[0],
