...
ANGSTROM = (1e-10, ['A', 'Angstrom', 'Angstroms', 'ångström', 'Ångström', 'Å'], 'NANOMETER')
NANOMETER = (1e-9, ['nm', 'nanometer', 'nanometers', 'nanometre', 'nanometres'], 'MICROMETER')
# Main symbol — µ (U+00B5), second — μ (U+03BC)
MICROMETER = (1e-6, ['µm', 'micrometer', 'micrometers', 'micrometre', 'micrometres', 'μm', 'um'], 'MILLIMETER')
MILLIMETER = (0.001, ['mm', 'millimeter', 'millimeters', 'millimetre', 'millimetres'], 'CENTIMETER')
CENTIMETER = (0.01, ['cm', 'centimeter', 'centimeters', 'centimetre', 'centimetres'], 'METER')
DECIMETER = (0.1, ['dm', 'decimeter', 'decimeters', 'decimetre', 'decimetres'], 'METER')
METER = (1, ['m', 'meter', 'meters', 'metre', 'metres'], 'FOOT')
HECTOMETER = (100, ['hm', 'hectometer', 'hectometers', 'hectometre', 'hectometres'], 'METER')
